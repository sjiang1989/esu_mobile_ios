//
//  RegistrationDropResultsViewController.m
//  Mobile
//
...
#import "RegistrationDropResultsViewController.h"
#import "RegistrationTabBarController.h"
#import "Module.h"
#import "Ellucian_GO-Swift.h"

@interface RegistrationDropResultsViewController ()

@end

@implementation RegistrationDropResultsViewController

-(void) viewDidAppear:(BOOL)animated
{
    [super viewDidAppear:animated];
    [self sendView:@"Registration Drop Results" moduleName:self.module.name];
}
...
- (UIView *)resultsHeader:(UITableView *)tableView
{
    ...
    label2.text = NSLocalizedString(@"These issues may have prevented drop.", @"second message for heading of failed drop classes");
...
- (UIView *)successResultsHeader:(UITableView *)tableView
{
    ...
    label.text = NSLocalizedString(@"Dropped Successfully!", @"message for heading of successful dropped classes");
...
- (UIView *)failureResultsHeader:(UITableView *)tableView
{
    ...
    label2.text = NSLocalizedString(@"We couldn't drop these courses:", @"second message for heading of failed drop classes");
